...
SECRET_KEY = "django-insecure-rp6h+e+qrleb!yy4yjxe7zgnuo!kd+4mli!3%4lq+xjfxqd%*t"
...
TEMPLATES = [
    {
        ...
        # FIX: Pointing Django directly to your frontend folder!
...
DATABASES = {
    'default': {
        ...
        'OPTIONS': {
            'timeout': 20,  # Tells SQLite to wait up to 20 seconds for the lock to clear
        }
    }
}
